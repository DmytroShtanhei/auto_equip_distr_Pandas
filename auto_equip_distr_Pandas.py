...
df_grouping = pd.read_excel("Групування.xlsx", usecols="D, H, M")  # optional parameter: sheet_name="Лист1"

# Fill out missing values for "Поз. в Договорі"
df_grouping = df_grouping.fillna(method="pad")

# Add information about Warehouses
df_lvu_warehouses = pd.read_excel("ЛВУ - коди-назви.xlsx", usecols="A, E")
...
df_lvu_names = pd.read_excel("ЛВУ - коди-назви.xlsx", usecols="A, C")
...
df_warehouses_info = pd.read_excel("ЛВУ - коди-назви.xlsx", usecols="E:H")
...
df_contract = pd.read_excel("Склад.xlsx", usecols="A:C, E:F")
